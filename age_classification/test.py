...
images_root = Path("test_images/kriti_dataset_faces")
...
# Label translation
label_translation = {0: "<= 12", 1: "13 to 17", 2: ">= 18"}
...
if precision.size == 3:
    ...
    print("Precision {}: {:.4f}".format(label_translation[0], precision[0]))
...
if recall.size == 3:
    ...
    print("Recall {}: {:.4f}".format(label_translation[0], recall[0]))
